...
const (
	LinkService_AddLink_FullMethodName = "/link.LinkService/AddLink"
...
func (c *linkServiceClient) AddLink(ctx context.Context, in *AddLinkRequest, opts ...grpc.CallOption) (*LinkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LinkResponse)
	err := c.cc.Invoke(ctx, LinkService_AddLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLinkServiceServer) AddLink(context.Context, *AddLinkRequest) (*LinkResponse, error) {
...
func _LinkService_AddLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LinkService_AddLink_FullMethodName,
	}
...
var LinkService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "back-end/proto/link.proto",
}
